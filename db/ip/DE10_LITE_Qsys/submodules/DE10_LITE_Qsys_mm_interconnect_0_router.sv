...
(
    ...
    localparam PAD7 = log2ceil(64'h4041058 - 64'h4041050); 
    localparam PAD8 = log2ceil(64'h4041060 - 64'h4041058); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h4041060;
    ...
    // ( 0x4041050 .. 0x4041058 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h4041050  && read_transaction  ) begin
            src_channel = 9'b000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x4041058 .. 0x4041060 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 27'h4041058   ) begin
